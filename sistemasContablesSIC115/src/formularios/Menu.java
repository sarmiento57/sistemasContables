...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"SIC115"},
        {"~Contablidad General~"},
        {"Menu Contable","Catalogo de cuentas", "Registrar transacción", "Libro mayor", "Balance de comprobación", "Estado de resultado", "Balance general"},
        {"~Gestión de proyectos~"},
        {"Panel de Proyectos", "Planilla general", "Solicitud de servicio"},
        {"~Otros~"},
        {"Logout"},
        {"Exit"}
    };
    ...
    private final String headerName = "Desarrollo Digital";
    ...
    public static void main(String[] args) {
        ...
        frame.add(menu); // Agrega el menú al frame
